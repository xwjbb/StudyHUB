...
<header id="top">
    <div id="logo" class="lf">
        <img src="<%=path%>/images/header/logo.png" alt="logo"/>
    </div>
    <div id="top_input" class="lf">
        ...
        <a href="javascript:void(0);" class="rt"><img id="search" src="<%=path%>/images/header/search.png" alt="搜索"/></a>
    </div>
    <%
    ...
    <div class="rt">
        <ul class="lf">
            ...
            <li><a href="personage.jsp">个人中心</a></li>
        </ul>
    </div>
</header>
<!-- nav主导航-->
...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="product_details.html"><img src="<%=path%>/images/index/index_banner1.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="product_details.html"><img src="<%=path%>/images/index/index_banner2.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="product_details.html"><img src="<%=path%>/images/index/index_banner3.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="product_details.html"><img src="<%=path%>/images/index/index_banner4.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="product_details.html"><img src="<%=path%>/images/index/index_banner5.png" alt=""></a>
        </li>
    </ul>
...
<div id="product">
    <div class="product_1 lf">
        <div class="aside lf">
            <img id="aside_image" src="<%=path%>/images/index/index_Sbanner_img1.png" alt=""/>
        </div>
        <div class="text rt">
    ...
    <div class="product_2 lf">
        ...
        <div class="aside lf">
            <img id="aside_image2" src="<%=path%>/images/index/index_Sbanner_img2.png" alt=""/>
        </div>
        <div class="text rt">
    ...
    <div class="product_3 lf">
        <div class="aside lf">
            <img id="aside_image3" src="<%=path%>/images/index/index_Sbanner_img3.png" alt=""/>
        </div>
        <div class="text rt">
            <p class="ys1">刀鱼焖排骨</p>
...
<div id="study">
    ...
    <div class="study_left lf">
        <div id="product_parameters_main">
            <p><img src="<%=path%>/images/index/wenan.png" alt=""/></p>
        ...
        <img id="study_product_main" src="<%=path%>/images/index/index_hot_study_img1.png" alt=""/>
    </div>
    <div class="study_right rt">
        <div class="right_top">
            ...
            <img id="study_product_vice1" src="<%=path%>/images/index/index_hot_study_img2.png" alt=""/>
        </div>
        <div class="right_bottom">
            <div id="product_parameters_vice2">
                ...
                <p class="view_details"><a href="product_details.html" >查看详情</a></p>
                <img id="study_product_vice2" src="<%=path%>/images/index/index_hot_study_img3.png" alt=""/>
            </div>
        </div>
    </div>
</div>
...
<div id="gourmet">
    ...
    <div class="food_detail rt">
        <div>
            <div class="food1 lf">
                <img src="<%=path%>/images/index/index_hot_food_img1.png" alt=""/>
            ...
            <div class="food1 lf">
                <img src="<%=path%>/images/index/index_hot_food_img2.png" alt="" id="food1"/>
            ...
            <div class="food1 lf" >
                <img src="<%=path%>/images/index/index_hot_food_img3.png" alt=""/>
